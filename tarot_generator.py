...
def create_prompt(card_name: str) -> str:
    ...
    base_prompt = """Create a complete, full-frame tarot card illustration in the style of ornate luxury tarot decks, with intricate gold and silver foil embellishments, rich jewel-tone colors, and a magical, occult atmosphere. The image should show the ENTIRE tarot card from edge to edge, including a lavish, embossed border with swirling floral and celestial patterns, reminiscent of illuminated manuscripts and Art Nouveau. The central scene should vividly depict **{}**, faithful to the Rider-Waite-Smith symbolism but enhanced with modern high-end fantasy art detailing. The textures should shimmer as if printed with metallic foil on high-quality cardstock, with dramatic lighting, lush backgrounds, and a sense of mystical grandeur. Show the complete tarot card format with visible borders and frame."""
    
    # Special handling for cards that might trigger safety filters
    safe_modifications = {
        "Judgement": "Create a complete, full-frame tarot card illustration in the style of ornate luxury tarot decks, with intricate gold and silver foil embellishments, rich jewel-tone colors, and a magical, occult atmosphere. The image should show the ENTIRE tarot card from edge to edge, including a lavish, embossed border with swirling floral and celestial patterns, reminiscent of illuminated manuscripts and Art Nouveau. The central scene should depict **Judgement** with an angel blowing a trumpet in cloudy skies above, and fully clothed figures rising with arms raised in reverence below, faithful to tarot symbolism but tasteful and appropriate. The textures should shimmer as if printed with metallic foil on high-quality cardstock, with dramatic lighting, lush backgrounds, and a sense of mystical grandeur. Show the complete tarot card format with visible borders and frame.",
        "The Devil": "Create a complete, full-frame tarot card illustration in the style of ornate luxury tarot decks, with intricate gold and silver foil embellishments, rich jewel-tone colors, and a magical, occult atmosphere. The image should show the ENTIRE tarot card from edge to edge, including a lavish, embossed border with swirling floral and celestial patterns, reminiscent of illuminated manuscripts and Art Nouveau. The central scene should depict **The Devil** as a horned figure on a throne with chained figures below, all fully clothed and tastefully depicted, faithful to tarot symbolism. The textures should shimmer as if printed with metallic foil on high-quality cardstock, with dramatic lighting, lush backgrounds, and a sense of mystical grandeur. Show the complete tarot card format with visible borders and frame.",
        "The Star": "Create a complete, full-frame tarot card illustration in the style of ornate luxury tarot decks, with intricate gold and silver foil embellishments, rich jewel-tone colors, and a magical, occult atmosphere. The image should show the ENTIRE tarot card from edge to edge, including a lavish, embossed border with swirling floral and celestial patterns, reminiscent of illuminated manuscripts and Art Nouveau. The central scene should depict **The Star** with a modestly clothed figure pouring water under starry skies, faithful to tarot symbolism but appropriate and tasteful. The textures should shimmer as if printed with metallic foil on high-quality cardstock, with dramatic lighting, lush backgrounds, and a sense of mystical grandeur. Show the complete tarot card format with visible borders and frame."
    }
...
def generate_all_major_arcana(delay_seconds: int = 2, method: str = "openai") -> None:
    ...
    print(f"📱 Using GPT-Image-1 model")
    print("=" * 50)
    ...
    for i, card in enumerate(MAJOR_ARCANA, 1):
        print(f"\n[{i}/22] Generating {card['name']} ({card['number']}) with GPT-Image-1...")
...
def generate_single_card(card_name: str, method: str = "openai") -> None:
    ...
    prompt = create_prompt(card['name'])
    print(f"🔮 Generating {card['name']} using GPT-Image-1...")
    success = generate_image(prompt, card['filename'], method=method)
